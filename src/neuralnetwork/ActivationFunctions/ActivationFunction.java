...
public interface ActivationFunction extends DoubleUnaryOperator{
     ...
     * This class encapsulates the value of a function and its derivative at
     * some operand.
     * Typing is not used to avoid boxing.
     */
     ...
     * to allow an implementation that avoids redundant calculations between
     * the derivative and the value.
     * @param x The operand.
    ...
    /**
     * The derivative and value of this function at x, with the value 
     * computed in place.  This method is provided
     * to allow an implementation that avoids redundant calculations between
     * the derivative and the value.
     * @param x The operand.
     * @return The derivative and value of this function at x.
